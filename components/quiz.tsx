...
const questions: Question[] = [
  {
    ...
    correct: 1,
    fact: "IIT was founded in 1940 through the merger of Armour Institute and Lewis Institute!",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    question: "IIT is ranked #1 in the nation for what?",
    options: [
    ...
    correct: 0,
    fact: "IIT consistently ranks #1 for Return on Investment among Illinois universities - your education pays off!",
  },
  {
    id: 4,
    question: "What is IIT's student-to-faculty ratio?",
    options: ["30:1", "20:1", "13:1", "50:1"],
    correct: 2,
    fact: "With a 13:1 ratio, you get personalized attention and mentorship from world-class faculty!",
  },
  {
    id: 5,
    question: "How many research centers and labs does IIT have?",
    options: ["5", "15", "30+", "100+"],
    correct: 2,
    fact: "IIT has 30+ research centers where students work on cutting-edge projects in AI, cybersecurity, energy, and more!",
  },
]
